...
export default function ProdutoClonado() {
  ...
  const images = [
    { url: 'https://www.bubbles.com.br/cdn/shop/files/kit-pet-fondue-de-chocolate-xperience-4-produtos-3676550.jpg', alt: 'Kit Pet Fondue de Chocolate Xperience' }
  ];
    ...
    <div className="font-poppins text-black bg-white min-h-screen relative pb-20 md:pb-0">
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "Product",
              "name": "KIT PET FONDUE DE CHOCOLATE XPERIENCE [4 PRODUTOS]",
              "image": ["https://www.bubbles.com.br/cdn/shop/files/kit-pet-fondue-de-chocolate-xperience-4-produtos-3676550.jpg"],
              "description": "Transforme o banho em uma experiência sensorial única com o Kit Fondue de Chocolate da linha Xperience Bubbles.",
              "sku": "BUB-FONDUE-KIT",
              "mpn": "BUB-FONDUE-KIT",
              "brand": { "@type": "Brand", "name": "Bubbles Pet" },
              "offers": {
                "@type": "Offer",
                "url": "https://bubblespet.com.br/products/kit-pet-fondue-de-chocolate-xperience",
                "priceCurrency": "BRL",
            ...
            },
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "O que vem no Kit Pet Fondue de Chocolate?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "O kit completo Xperience inclui: Shampoo Fondue 1L (diluição 1:4), Máscara de Hidratação 450g, Leave-in Finalizador 300ml e Perfume 300ml."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Quais são os principais benefícios do Kit Pet Fondue?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "O kit proporciona limpeza e reparação inteligente, hidratação profunda, maciez intensa e um perfume marcante de chocolate, ideal para uma experiência de Spa."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Pode ser utilizado em cães e gatos?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Sim, todos os produtos da linha Fondue de Chocolate são seguros e indicados para uso em cães e gatos."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Qual o rendimento do Shampoo?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "O Shampoo possui rendimento profissional com diluição de 1:4, permitindo fazer muito mais banhos com o frasco de 1L."
                  }
                }
              ]
            },
            {
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "name": "Kit Pet Fondue de Chocolate Xperience",
                  "item": "https://bubblespet.com.br/products/kit-pet-fondue-de-chocolate-xperience"
                }
              ]
            }
          ])
      ...
      <div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 py-3 text-[11px] text-[var(--text-mid)] flex items-center gap-2 overflow-x-auto no-scrollbar whitespace-nowrap">
          ...
          <span>&gt;</span>
          <span className="text-black">Kit Pet Fondue de Chocolate Xperience</span>
        </div>
        ...
        <section className="max-w-[1200px] mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-[55%_45%] gap-8 md:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-[20px] md:text-[26px] font-[600] text-[var(--text-dark)] leading-[1.2] mb-2 uppercase text-left">
              KIT PET FONDUE DE CHOCOLATE XPERIENCE [4 PRODUTOS]
            </h1>
          ...
          <div className="max-w-[1240px] mx-auto">
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
              ...
              <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                {[
                  { title: "Proteção Antioxidante", desc: "Tecnologia COVERTRIX que protege a pelagem do ressecamento de dentro para fora.", icon: Shield },
                  { title: "Hidratação Profunda", desc: "Nutrição intensa que repara, restaura e deixa o pelo macio e brilhante.", icon: Droplet },
                  { title: "Kit Completo de Serviço", desc: "Shampoo, máscara, leave-in e perfume em uma experiência sensorial única.", icon: Layers },
                  { title: "Fragrância Gourmand", desc: "Aroma sofisticado de chocolate com fixação de até 7 dias em classe Eau de Parfum.", icon: Sun }
                ].map((item, i) => (
        ...
        <section className="max-w-[800px] mx-auto px-4 py-16">
          ...
          <div className="border border-[var(--border)] rounded-[var(--radius-lg)] overflow-hidden bg-white">
            ...
            <div className="border-b border-[var(--border)]">
              ...
              {openAccordion === 1 && (
                <div className="px-6 pb-6 pt-2 text-[14px] text-[var(--text-mid)] leading-relaxed space-y-4">
                  <p>Transforme o banho em uma experiência sensorial única com o Kit Fondue de Chocolate da linha Xperience Bubbles. Inspirado no aroma envolvente do chocolate, este kit foi desenvolvido para criar um momento especial no banho, agregando valor ao serviço do pet shop e proporcionando uma experiência diferenciada para o tutor e para o pet.</p>
                  <p>Com uma fragrância marcante e textura agradável, os produtos trabalham em conjunto para promover limpeza eficiente, hidratação, maciez e perfume prolongado, deixando a pelagem mais bonita, sedosa e perfumada.</p>
                  <p>Ideal para banhos temáticos, datas sazonais ou serviços premium, o Kit Fondue de Chocolate transforma o banho em um verdadeiro ritual de cuidado e carinho.</p>
                  <p>Além do resultado estético, a experiência sensorial do chocolate desperta emoção e encantamento, ajudando o pet shop a aumentar o ticket médio utilizando os mesmos clientes, oferecendo um serviço diferenciado que encanta tutores e fideliza.</p>
                </div>
              )}
            </div>
              ...
              {openAccordion === 2 && (
                <div className="px-6 pb-6 pt-2 text-[14px] text-[var(--text-mid)] leading-relaxed">
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Limpeza eficiente e suave</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Hidratação e maciez para a pelagem</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Perfume intenso e duradouro</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Experiência sensorial diferenciada no banho</li>
                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-gray-300" /> Ideal para serviços premium em pet shops</li>
                  </ul>
                </div>
              )}
            </div>
            ...
            <div className="border-b border-[var(--border)] last:border-0">
              ...
              {openAccordion === 3 && (
                <div className="px-6 pb-6 pt-2 text-[14px] text-[var(--text-mid)] leading-relaxed">
                  <p>Lave com o Shampoo diluído (1:4), enxágue. Aplique a Máscara, deixe agir por 90 segundos e enxágue. Finalize com Leave-in nos pelos úmidos e borrife o Parfum a 15 cm da pelagem seca. Evite olhos e mucosas.</p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-stretch">
              ...
              <div className="relative p-8 md:p-10 rounded-[10px] bg-[#F9F9F9] border border-dashed border-gray-300 opacity-70">
                ...
                <ul className="space-y-5">
                  {[
                    "Cheiro fraco que some em poucas horas",
                    "Pelagem ressecada e sem proteção",
                    "Fórmula sem tecnologia de tratamento real",
                    "Kit sem identidade: produtos genéricos misturados"
                  ].map((text, i) => (
              ...
              <div className="relative p-8 md:p-10 rounded-[10px] bg-[#fdf5f7] border-2 border-[#F4CDD4] md:scale-[1.03] origin-center">
                ...
                <div className="mb-8">
                  <span className="text-[10px] font-bold text-[var(--pink)] uppercase tracking-[2px] mb-2 block">Bubbles Xperience</span>
                  <h3 className="text-xl md:text-2xl font-semibold text-black uppercase">O Padrão Bubbles</h3>
                </div>

                <ul className="space-y-5">
                  {[
                    "Fragrância sofisticada de chocolate com fixação de até 7 dias (Eau de Parfum)",
                    "Pelagem protegida, hidratada e com brilho profundo",
                    "Tecnologia COVERTRIX: ação antioxidante que protege do ressecamento",
                    "Kit completo com protocolo definido: shampoo, máscara, leave-in e perfume"
                  ].map((text, i) => (
                    <li key={i} className="flex items-start gap-3">
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="bg-white rounded-[var(--radius-md)] p-6 shadow-sm">
                ...
                <p className="text-[14px] text-[var(--text-mid)] leading-relaxed">
                  &quot;O cheiro de chocolate é surreal!! uso nos banhos premium aqui do pet e os tutores ficam enlouquecidos com o resultado.. a pelagem fica extremamente macia e hidratada.&quot;
                </p>
              </div>
              ...
              <div className="bg-white rounded-[var(--radius-md)] p-6 shadow-sm">
                ...
                <p className="text-[14px] text-[var(--text-mid)] leading-relaxed">
                  &quot;Comprei o kit fondue pra testar na páscoa e foi um sucesso absoluto. o perfume dura dias no pelo, super recomendo p quem quer agregar valor no banho!&quot;
                </p>
              </div>
              ...
              <div className="bg-white rounded-[var(--radius-md)] p-6 shadow-sm">
                ...
                <p className="text-[14px] text-[var(--text-mid)] leading-relaxed">
                  &quot;Que experiência incrivel. Nunca vi uma máscara de hidratação derreter tão fácil no pelo.. parece q o cachorro saiu do spa mesmo rs&quot;
                </p>
              </div>
            </div>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-md overflow-hidden relative border border-gray-100 hidden sm:block">
            <Image src={images[0].url} alt="Miniatura do Kit Pet Fondue de Chocolate" fill className="object-cover" loading="lazy" />
          </div>
          <div className="flex flex-col">
            <span className="text-[12px] font-[700] text-[var(--text-dark)] truncate max-w-[180px] md:max-w-none block">Kit Pet Fondue de Chocolate</span>
